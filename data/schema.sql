...
CREATE TABLE users (
    ...
    can_access_outsourcing TINYINT(1) DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (role_id) REFERENCES roles(id)
);
...
CREATE TABLE projects (
    ...
    project_stage VARCHAR(40) NOT NULL DEFAULT 'Discovery',
...
CREATE TABLE timesheets (
    ...
    had_blocker TINYINT(1) NOT NULL DEFAULT 0,
    blocker_description TEXT NULL,
    had_significant_progress TINYINT(1) NOT NULL DEFAULT 0,
    generated_deliverable TINYINT(1) NOT NULL DEFAULT 0,
    operational_comment TEXT NULL,
    linked_stopper_id BIGINT NULL,
...
INSERT INTO clients (name, sector_code, category_code, priority_code, status_code, pm_id, satisfaction, nps, risk_code, tags, area_code, logo_path, feedback_notes, feedback_history, operational_context)
