...
$view = in_array($view, ['resumen', 'documentos', 'pmo', 'seguimiento', 'bloqueos', 'horas'], true) ? $view : 'documentos';
...
<script>
    ...
    // Schedule/PMO editor scripts live in views/projects/pmo.php
