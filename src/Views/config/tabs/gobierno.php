        ...
        <div class="card config-card governance-block">
            <div class="card-content">
                ...
                <div class="config-form-grid">
                    ...
                    <label class="input-stack"><span>PMO · Indicadores · meta_cumplimiento_requisitos (%)</span><input name="meta_cumplimiento_requisitos" form="governance-config-form" type="number" min="0" max="100" value="<?= htmlspecialchars((string) ($configData['operational_rules']['health_scoring']['meta_cumplimiento_requisitos'] ?? $configData['operational_rules']['health_scoring']['requirements_indicator']['target'] ?? 95)) ?>"></label>
