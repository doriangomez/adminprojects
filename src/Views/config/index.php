<style>
    ...
    #tab-notificaciones:checked ~ .tab-nav label[for="tab-notificaciones"] {
    ...
    #tab-notificaciones:checked ~ .tab-panels #panel-notificaciones {
        display: block;
    }
    .config-card {
        background: var(--surface);
...
<section class="section-grid">
    <div class="config-tabs">
        ...
        <input type="radio" name="config_tab" id="tab-notificaciones">
        ...
        <div class="tab-nav">
            ...
            <label for="tab-notificaciones">Notificaciones</label>
        </div>
