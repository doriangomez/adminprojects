        ...
        <div class="column">
            ...
            <?php foreach($items as $task): ?>
                <div class="card-task">
                    ...
                    <p style="margin:4px 0; color: var(--gray);">Proyecto: <?= htmlspecialchars($task['project']) ?></p>
                    <p style="margin:4px 0; color: var(--gray);">Responsable: <?= htmlspecialchars($task['assignee'] ?? 'Sin asignar') ?></p>
                    ...
                    <small style="color: var(--gray);">Vence: <?= htmlspecialchars($task['due_date']) ?></small>
                </div>
            <?php endforeach; ?>
        </div>
    <?php endforeach; ?>
