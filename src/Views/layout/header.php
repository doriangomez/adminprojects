...
<head>
    ...
    <style>
        ...
        * {
        ...
        .user-chip strong { color: var(--text-strong); font-size: 14px; }
        ...
        @media (max-width: 1024px) {
            ...
            .sidebar { position: relative; width: 100%; flex-direction: row; align-items:center; gap:14px; min-height: unset; border-bottom: 1px solid var(--border); border-right: none; padding: 16px 18px; }
            .sidebar h1 { font-size: 16px; }
            .sidebar nav { flex-direction: row; flex-wrap: wrap; gap: 8px; }
            .sidebar a { flex: 1 1 140px; text-align: center; justify-content: center; border-radius: 10px; padding-inline: 12px; }
